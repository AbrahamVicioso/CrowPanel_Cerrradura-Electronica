...
lv_obj_t* error_screen_create(void)
{
    ...
    lv_obj_clear_flag(screen_error, LV_OBJ_FLAG_SCROLLABLE);

    // Círculo error — centrado, 1/3 superior
    ...
    lv_obj_set_style_text_font(label_message, &lv_font_montserrat_18, 0);
    ...
    lv_obj_set_width(label_message, 700);
    lv_obj_align(label_message, LV_ALIGN_CENTER, 0, 66);
